 ...
 */
BoaClient.prototype.datasets = async function datasets(filter = undefined) {
  return new Promise((resolve) =>
 ...
 */
BoaClient.prototype.datasetNames =
  async function datasetNames(filter = undefined) {
    return new Promise(
        (resolve) => {
 ...
 * @return {Promise<*>} a handle to the new job
 */
 ...
 * @return {Promise<*>} a handle to the job
 */
 ...
 * @return {Promise<*>} a handle to the last job
 */
BoaClient.prototype.lastJob = async function lastJob() {

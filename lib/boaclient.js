...
const BOA_API_ENDPOINT = 'https://boa.cs.iastate.edu/boa/?q=boa/api';
module.exports.BOA_API_ENDPOINT = BOA_API_ENDPOINT;
const BOAC_API_ENDPOINT = 'https://boa.cs.iastate.edu/boac/?q=boa/api';
...
function BoaClient(endpoint) {
  this.client = new XMLRPCClient(
      typeof endpoint !== 'undefined' ? endpoint : BOA_API_ENDPOINT,
      true);
